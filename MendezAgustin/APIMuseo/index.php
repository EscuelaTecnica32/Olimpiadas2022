        ...
        switch ($consulta) {
            ...
            case 'obtenerTurnosDisponibles':
                ...
                while ($row = $query->fetch_assoc()){
                    $json[] = array(
                        ...
                        "fecha" => $row['fecha'],
                        "hora" => $row['hora'],
                        "reserva_turno" => $row['reserva_turno']
                    );
                }
                echo json_encode($json);
                break;
            case 'insertarRecorrido':
                if(isset($_GET['actividades']) && isset($_GET['tematica']) && isset($_GET['duracion'])){
                    $sql = "INSERT INTO recorrido(actividades, tematica, duracion) VALUES ('".$_GET['actividades']."', '".$_GET['tematica']."','".$_GET['duracion']."')";
            ...
            case 'insertarUsuario':
                if(isset($_GET['nombre'])){
                    $sql = "INSERT INTO usuarios(nombre) VALUES ('".$_GET['nombre']."')";
